...
fun main() {
    ...
    // och sedan omvandlar det resulterande binära talet till decimalform. Att bokstäverna i pusslet gick
    ...
    //
    // Kotlins dokumentation har en liknande lösning på samma pussel, men använder string-metoden .replace() för att
    // byta ut bokstäverna mot 1:or och 0:or:
    // https://kotlinlang.org/docs/advent-of-code.html#day-5-binary-boarding
    ...
    // igen, tar det minsta av de två tal som returneras med min(), och adderar 1, så får jag rätt svar.
    // https://todd.ginsberg.com/post/advent-of-code/2020/day5/
